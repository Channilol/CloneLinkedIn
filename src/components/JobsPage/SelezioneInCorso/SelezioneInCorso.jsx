        ...
        {jobsData.slice(0, initialCardCount).map((job, index) => (
          <div key={index} className="cardConsigli">
            ...
            <div className="cardConsigliDettagli">
              ...
              <p className="PSelezLav3"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="green" class="bi bi-check2-circle" viewBox="0 0 16 16">
  <path d="M2.5 8a5.5 5.5 0 0 1 8.25-4.764.5.5 0 0 0 .5-.866A6.5 6.5 0 1 0 14.5 8a.5.5 0 0 0-1 0 5.5 5.5 0 1 1-11 0"/>
  <path d="M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0z"/>
</svg> Pubblicato il {job.publication_date}  </p>
<p className="PSelezLav4">Promosso da <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0a66c2" class="bi bi-linkedin" viewBox="0 0 16 16">
