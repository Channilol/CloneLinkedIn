        ...
        <Navbar expand="lg" className="custom-navbar">
            <Container>
                <Navbar.Brand href="#home">
                    <svg xmlns="http://www.w3.org/2000/svg" width="37" height="37" fill="#0a66c2" className="bi bi-linkedin changeColorSvg" viewBox="0 0 16 16">
                ...
                <div className="search-container-navbar">
                    ...
                    <input type="text" className="search-input-navbar" placeholder="Cerca" />
                </div>
                <Navbar.Toggle aria-controls="basic-navbar-nav" />
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        <Nav.Link href="#home" className="customTest">
                            <div className="divIconsNav me-2">
                        ...
                        <div className="containerIconsNav pe-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-person-circle customPositionSvg" viewBox="0 0 16 16">
                                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
                                <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1" />
                            </svg>
                            <NavDropdown title="Tu" className="customNavDropdown" id="basic-nav-dropdown">
                                <NavDropdown.Item href="#">
                                    <div className="sectionNavDropdown">
                        ...
                        <div className="containerIconsNav" id="borderContainerIconsNav">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#404040" className="bi bi-grid-3x3-gap-fill customPositionSvg changeColorSvg" viewBox="0 0 16 16">
                            ...
                            <NavDropdown title="Per le aziende" className="customNavDropdown" id="basic-nav-dropdown">
                                <p className="ms-2">Nessuna info disponibile al momento</p>
                            </NavDropdown>
                        </div>
